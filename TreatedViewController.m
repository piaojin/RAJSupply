...
@interface TreatedViewController ()
{
...
@implementation TreatedViewController
...
- (void) initData
{
    ...
    NSString * strurl=[Tool Append:defaultWebServiceUrl witnstring:@"GetAllProductWithAudit"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    DoTableViewCell * cell=[tableview dequeueReusableCellWithIdentifier:idtcell];
    if (cell==nil) {
        cell=[[DoTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:idtcell];
    }
    ...
    if(data!=nil)
    {
        ...
        cell.state.text=stateimagename;
        cell.state.textColor = color;
        
    }
    cell.accessoryType=UITableViewCellAccessoryDetailButton;
    //针对于ios7 tableview 的栏没有靠左
...
- (void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    PDetailViewController *Cannotview=[[PDetailViewController alloc] init];
